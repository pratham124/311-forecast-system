...
**Goal in Context**: Allow city planners and city planners to review recent forecast accuracy and compare past predictions to actual outcomes so they can evaluate performance and build trust in the system.  
**Scope**: Operations Analytics System  
**Level**: User Goal  
**Primary Actor**: City Planner or city planner  
...
A city planner or city planner wants to understand how well the forecasting system has performed recently. The user opens the forecast performance analysis interface.
