...
class ThresholdConfiguration(Base):
    ...
    # Keep Python attribute stable while mapping to the existing DB column name.
    notification_channels_json: Mapped[str] = mapped_column("notification_channels_csv", Text, nullable=False)
...
class ThresholdEvaluationRun(Base):
    ...
    weekly_forecast_run_id: Mapped[str | None] = mapped_column(
        ForeignKey("weekly_forecast_runs.weekly_forecast_run_id"), nullable=True
    )
...
class ThresholdScopeEvaluation(Base):
    ...
    threshold_evaluation_run_id: Mapped[str] = mapped_column(
        ForeignKey("threshold_evaluation_runs.threshold_evaluation_run_id"), nullable=False
    )
    threshold_configuration_id: Mapped[str | None] = mapped_column(
        ForeignKey("threshold_configurations.threshold_configuration_id"), nullable=True
    )
    service_category: Mapped[str] = mapped_column(String(255), nullable=False)
    geography_type: Mapped[str | None] = mapped_column(String(64), nullable=True)
    geography_value: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    forecast_bucket_value: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False)
    ...
    notification_event_id: Mapped[str | None] = mapped_column(
        ForeignKey("notification_events.notification_event_id"), nullable=True
    )
...
class ThresholdState(Base):
    ...
    threshold_configuration_id: Mapped[str] = mapped_column(
        ForeignKey("threshold_configurations.threshold_configuration_id"), nullable=False
    )
    service_category: Mapped[str] = mapped_column(String(255), nullable=False)
    geography_type: Mapped[str | None] = mapped_column(String(64), nullable=True)
    geography_value: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    last_forecast_bucket_value: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False)
    last_threshold_value: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False)
...
class NotificationEvent(Base):
    ...
    forecast_window_end: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    forecast_window_type: Mapped[str] = mapped_column(String(32), nullable=False)
    forecast_value: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False)
    threshold_value: Mapped[float] = mapped_column(Numeric(12, 2), nullable=False)
...
class NotificationChannelAttempt(Base):
    ...
    notification_event_id: Mapped[str] = mapped_column(
        ForeignKey("notification_events.notification_event_id"), nullable=False
    )
